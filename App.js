...
export default class App extends Component<Props> {
  ...
  async componentDidMount() {
    const repos = JSON.parse(await AsyncStorage.getItem('@Native:repositories')) || [];
    this.setState({repos});
  }
  ...
  _addRepository = async (newRepoText) => {
    ...
    this.setState({
          modalVisible: false,
          repos: [
            ... this.state.repos, repository
          ]
    });

    await AsyncStorage.setItem('@Native:repositories', JSON.stringify(this.state.repos))
  };
